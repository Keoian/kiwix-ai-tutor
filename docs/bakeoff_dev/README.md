...
| Tool calls: malformed / correct decisions | 0/20 malformed, 20/20 correct decisions, 10/20 parsed (reconciled 2026-09-20 against toolcall_results.json) | 0/20 malformed, 20/20 correct decisions, 10/20 parsed (ternary.md) | 0/20 malformed (0.00%), 19/20 correct decisions, 11/20 parsed (granite.md) |
